...
- [**Actors**](05-actors.md) supplies the **actor parameter** the law leaves open — the pinning-resolution spectrum, the floor's location in the acceptance predicate, selection versus training, and how composite actors allocate seam demand. The part of the framework with the least prior art.
- [**Lineage and Limits**](06-lineage-and-limits.md) is the law's **ledger**: what it stands on (Ashby, Tesler, Brooks, Meyer, Kalman), where it was corrected, where it retreated, and the falsification debts it still owes.
