...
> **Apparatus §4 — informative.** How the apparatus maps to the standard 0–5 autonomy ladder, why per-role autonomy is the unit, and why the ceiling of any role is the measured [Polanyi floor](../core/03-the-polanyi-floor.md) of its task type, never an assertion — with the caveat that, if the [zero-floor postulate](../core/03-the-polanyi-floor.md#the-zero-floor-postulate-the-floor-is-in-the-predicate) holds, Level 5 is in principle reachable for every task type whose acceptance predicate is decidable over digital ground. Not required for conformance; supplied for readers already thinking in autonomy levels.
>
