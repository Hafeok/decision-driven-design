...
## On acceptance of the upstream PR (the staged steps)

1. Tag `v5.7.0` (the merge is the ratification act for the three term settlements).
2. Downstream ref bumps v5.6.0 → v5.7.0; predicted W6/W7 firing: **none** (frame-01's change
   notes-only; frame-02/03/07 unpinned; no new term shadowed).
3. Three pins added at the bump: `DDD-frame-14`, `DDD-hyp-04`, `DDD-hyp-05` (the annotations'
   bases; unpinnable at v5.6.0 where the ids do not exist).
4. The downstream PR stands.
