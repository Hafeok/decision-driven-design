...
> **Appendix — informative.** Definitions for terms the framework uses but does not itself define, because they come from external work.

A short reference for terms the DDD docs use but do not define, because they come from outside the framework. The [Entity Reference](02-entities.md) covers DDD's own vocabulary; this page covers everything the docs *reference* from established work elsewhere.
