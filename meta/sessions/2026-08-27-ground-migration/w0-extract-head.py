...
# This session must not count itself, which is the mistake the audit made twice.
    ...
    for root, repo in roots:
        for dp, dn, fns in os.walk(root):
            ...
            for fn in fns:
                ...
                if rel.startswith(SELF) or rel.startswith(SELF2):
                    continue
                try:
...
if __name__ == '__main__':
    rows = run([('/home/user/actor-indexed-determination','upstream'),
                ...
                ('/home/user/product-cli','product-cli')])
